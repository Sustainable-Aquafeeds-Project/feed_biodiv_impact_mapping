...
ggsave(here(this_dir, "/SI_plots/extra_plots/SI_fig_economic_barchart.png"), width = 178.9, height =100.92 , units = "mm", bg = "white")
...
ggsave(here(this_dir, "SI_plots/extra_plots/SI_fig_barchart_by_raw_mat.png"), width = 178.9, height =100.92 , units = "mm", bg = "white")
...
**SI Figure 3: Comparison of raw material contribution to diet formulation vs. total impacts**
...
ggsave(here("analysis/SI_plots/SI_Fig_3_efficiency.png"), width = 178.9, height =100.92 , units = "mm", bg = "white")
...
ggsave(here(this_dir, "SI_plots/extra_plots/SIfig_economic_boxplot_prop.png"), width = 16, height = 9, units = "in", bg = "white", plot = p, dpi = 300) # technically for nature food the max width is 180 mm, however, I'm saving like this and adjusting save in post production because doing it here messing things up...
```
