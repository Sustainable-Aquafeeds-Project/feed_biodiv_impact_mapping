...
scale_arrow_plot <- ggplot() +
  ...
  ggspatial::annotation_scale(
      ...
      bar_cols = c("grey60", "white"),
      text_family = "sans",
      width_hint = 0.5,  # Adjust the width of the scale bar
      pad_y = unit("0.7", "cm")
   ) 


ggsave(here("analysis/MS_plots/fig5_scale.png"), plot = scale_arrow_plot, dpi = 300, bg = "white", height = 16, width = 16, units = "cm")

ggsave(here("analysis/MS_plots/fig5_base_map.png"), plot = map_plot, dpi = 300, bg = "white", height = 16, width = 16, units = "cm")
...
ggsave(here("analysis/SI_plots/NOR_scale.png"), plot = scale_arrow_plot, dpi = 300, bg = "white", height = 16, width = 16, units = "cm")

ggsave(here("analysis/SI_plots/NOR_basemap.png"), plot = map_plot, dpi = 300, bg = "white", height = 16, width = 16, units = "cm")
