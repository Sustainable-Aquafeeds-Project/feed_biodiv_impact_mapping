...
fd_df <- all_df %>% filter(diet == "fish-dominant")
quantile(fd_df$value, c(0.05,0.95)) 
## fish-dominant
#                    5%                   95% 
# 0.0000000000007554628 0.0000433040193456690 

pd_df <- all_df %>% filter(diet == "plant-dominant")
quantile(pd_df$value, c(0.05,0.95))
## plant-dominant
#                    5%                   95% 
# 0.0000000000007491303 0.0000603930651777774 

quantile(all_df$value, c(0.05,0.95))
## both scenarios
#                    5%                   95% 
# 0.0000000000007520312 0.0000510675588884619 
...
2. Destructive gear types liek trawling and dregding
