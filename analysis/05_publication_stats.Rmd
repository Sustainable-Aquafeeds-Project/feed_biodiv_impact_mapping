...
"For instance, the highest impact occurs in a terrestrial cell in Norway, where the feed production activities (primarily wheat) for the plant-dominant scenario displace 11% of the habitat area on average for impacted species (e.g., Boreal owl, Moose)."
