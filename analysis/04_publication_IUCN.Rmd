...
In this script we create supplementary figure 6. In this figure, we split impacts by taxon and species IUCN risk category:
...
unique(test$taxon) ## cool none are empty

test <- spp_cats %>% filter(category == "NE") %>%   group_by(taxon) %>%
  summarise(n_distinct(sciname))
...
ggsave(here("analysis/MS_plots/fig4_iucn_plot_no_props.png"), units = "mm", width = 180, height = 180)
...
ggsave(here("analysis/SI_plots/SIfig_iucn_plot_zeros.png"), units = "mm", width = 180, height = 180)
