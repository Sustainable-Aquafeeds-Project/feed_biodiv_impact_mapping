...
ggsave(here("analysis/MS_plots/fig4_iucn_plot.png"), units = "mm", width = 180, height = 180)


```

Now save it without 0 impact species:
...
ggsave(here("analysis/SI_plots/SIfig_iucn_plot_no_zeros.png"), units = "mm", width = 180, height = 180)
