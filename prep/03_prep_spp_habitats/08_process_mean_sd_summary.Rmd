...
for(diet in diet_types){
  for(fcr in fcr_types){
    for(allocation in allocation_types){
      ...
      # if(file.exists(glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{allocation}_rarity_mean_prop.tif")))){
    ...
    for(i in 1:14){ # 14 because there are 14 difference indices in the list; maybe foreach here? Would have to save each "combined_dataframe" and read back in with a foreach loop. 
