...
# sens_type <- "minus-10"
      ...
      if(file.exists(glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_mean_prop.tif")))){
        message("raster exists... skipping")
        next()
      }

      all_files <- list.files(file.path(biodiv_dir, "output/impact_maps_by_spp_ingredient_lists"), pattern = glue(".*_{diet}_{fcr}_{sens_type}.*_{allocation}"), full.names = TRUE)
 ...
 combined_dataframe <- bind_rows(i_dfs) %>%
  ...
  as.data.frame()
      ...
      writeRaster(rast_impact, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_mean_prop.tif")), overwrite = TRUE)
      ...
      writeRaster(rast_ext, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_mean_ext_risk.tif")), overwrite = TRUE)
        ...
        filter(!is.na(cell_id)) %>%
            ...
            writeRaster(rast_impact_sd, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_sd_prop.tif")), overwrite = TRUE)
        ...
        filter(!is.na(cell_id)) %>%
            ...
            rast(., type = "xyz", crs = moll_template)
                  ...
                  writeRaster(rast_impact_nspp, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_nspp.tif")), overwrite = TRUE)
    ...
    rast_impact_rarity_prop <- all_impact_df %>%
        ...
        filter(!is.na(cell_id)) %>%
            ...
            rast(., type = "xyz", crs = moll_template)
                  ...
                  writeRaster(rast_impact_rarity_prop, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_rarity_mean_prop.tif")), overwrite = TRUE)
                  
                  
 rast_impact_rarity_km2 <- all_impact_df %>%
        dplyr::select(cell_id, rarity_km2_mean) %>%
        filter(!is.na(cell_id)) %>%
                left_join(moll_template_xy) %>%
            dplyr::select(x, y, rarity_km2_mean) %>%
            rast(., type = "xyz", crs = moll_template)

                  writeRaster(rast_impact_rarity_km2, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_rarity_mean_km2.tif")), overwrite = TRUE)
      ...
      rast_impact_total_km2 <- all_impact_df %>%
        ...
        filter(!is.na(cell_id)) %>%
            ...
            rast(., type = "xyz", crs = moll_template)
                        ...
                        writeRaster(rast_impact_total_km2, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_total_km2.tif")), overwrite = TRUE)
...
pattern <- glue(".*_{diet}_{fcr}_{sens_type}_.*_{allocation}_chunk_.*.qs")
...
any(file.exists(list.files(file.path(biodiv_dir, "int/marine_aggregation/sub_chunk_dfs/"), pattern = pattern, full.names = TRUE)))
        ...
        message(glue("skipping processing for {diet} {fcr} {allocation} {sens_type} because they exist"))
        next()
      }
      
      all_files <- list.files(file.path(biodiv_dir, "output/impact_maps_by_spp_ingredient_lists"), pattern = glue(".*_{diet}_{fcr}_{sens_type}_.*_{allocation}"), full.names = TRUE)
  ...
  qsave(combined_dataframe, glue(file.path(biodiv_dir, "int/marine_aggregation/sub_chunk_dfs/{taxa}_{diet}_{fcr}_{sens_type}_{fs_type}_{ingredient_type}_{allocation}_chunk_{i}.qs")))
...
for(diet in diet_types){
  for(fcr in fcr_types){
    for(allocation in allocation_types){
      ...
      if(file.exists(glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_mean_prop.tif")))){
      ...
      for(chunk_id in 1:13){
       ...
       # chunk_id = 1
        ...
        files <- list.files(file.path(biodiv_dir, "int/marine_aggregation/sub_chunk_dfs/"), pattern = glue(".*_{diet}_{fcr}_{sens_type}_.*_{allocation}_chunk_{chunk_id}.qs"), full.names = TRUE)
  ...
  as.data.frame()
      ...
      writeRaster(rast_impact, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_mean_prop.tif")), overwrite = TRUE)
        ...
        filter(!is.na(cell_id)) %>%
            ...
            writeRaster(rast_impact_sd, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_sd_prop.tif")), overwrite = TRUE)
        ...
        filter(!is.na(cell_id)) %>%
            ...
            rast(., type = "xyz", crs = moll_template)
                  ...
                  writeRaster(rast_impact_nspp, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_nspp.tif")), overwrite = TRUE)
      ...
      writeRaster(rast_ext, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_mean_ext_risk.tif")), overwrite = TRUE)
    ...
    rast_impact_rarity_prop <- all_impact_df %>%
        ...
        filter(!is.na(cell_id)) %>%
            ...
            rast(., type = "xyz", crs = moll_template)
                  ...
                  writeRaster(rast_impact_rarity_prop, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_rarity_mean_prop.tif")), overwrite = TRUE)
 ...
 rast_impact_rarity_km2 <- all_impact_df %>%
        ...
        filter(!is.na(cell_id)) %>%
            ...
            rast(., type = "xyz", crs = moll_template)
                  ...
                  writeRaster(rast_impact_rarity_km2, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_rarity_mean_km2.tif")), overwrite = TRUE)
      ...
      rast_impact_total_km2 <- all_impact_df %>%
        ...
        filter(!is.na(cell_id)) %>%
            ...
            rast(., type = "xyz", crs = moll_template)
                        ...
                        writeRaster(rast_impact_total_km2, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_total_km2.tif")), overwrite = TRUE)
  ...
  for(fcr in fcr_types){
    for(allocation in allocation_types){
      for(calc_type in calc_types){
        ...
        terrestrial_rast <- rast(glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_{calc_type}.tif"))) %>%
          project(., moll_template) # make sure same extents
      
        
            marine_rast <- rast(glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_{calc_type}.tif"))) %>%
              project(., moll_template) # make sure same extents
      ...
      writeRaster(total_rast, glue(file.path(biodiv_dir, "output/impact_maps_across_taxon_ingredient/{diet}/{fcr}/{sens_type}/{allocation}_{calc_type}.tif")), overwrite = TRUE)
...
foreach(allocation_type = allocations, 
  ...
  all_df <- as.data.frame(global_maps_mean, xy = TRUE) %>%
    ...
    separate_wider_delim(type, delim = "/", names = c("diet", "fcr_type", "sensitivity_scenario", "calc_type")) %>%
    rename(long = x, lat = y)
...
for(taxa in taxa_types){
 ...
 combined_dataframe <- bind_rows(i_dfs) %>%
  ...
  rast_impact_rarity_prop <- all_impact_df %>%
        ...
        qsave(rast_impact_rarity_prop, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_by_taxon_across_ingredient/{diet}/{fcr}/{allocation}_{taxa}_rarity_mean_prop.qs")))
  ...
  rast_impact_rarity_km2 <- all_impact_df %>%
        ...
        qsave(rast_impact_rarity_km2, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_by_taxon_across_ingredient/{diet}/{fcr}/{allocation}_{taxa}_rarity_mean_km2.qs")))
    ...
    rast_impact_total_km2 <- all_impact_df %>%
        ...
        qsave(rast_impact_total_km2, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_by_taxon_across_ingredient/{diet}/{fcr}/{allocation}_{taxa}_total_km2.qs")))
...
for(diet in diet_types){
  ...
  rast_impact_rarity_prop <- all_impact_df %>%
        ...
        qsave(rast_impact_rarity_prop, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_by_taxon_across_ingredient/{diet}/{fcr}/{allocation}_{taxa}_rarity_mean_prop.qs")))
  ...
  rast_impact_rarity_km2 <- all_impact_df %>%
        ...
        qsave(rast_impact_rarity_km2, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_by_taxon_across_ingredient/{diet}/{fcr}/{allocation}_{taxa}_rarity_mean_km2.qs")))
    ...
    rast_impact_total_km2 <- all_impact_df %>%
        ...
        qsave(rast_impact_total_km2, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_by_taxon_across_ingredient/{diet}/{fcr}/{allocation}_{taxa}_total_km2.qs")))
...
# for(raw_material in raw_materials){
 ...
 rast_impact_rarity_prop <- all_impact_df %>%
        ...
        qsave(rast_impact_rarity_prop, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_by_material/{diet}/{fcr}/{allocation}_{raw_material}_rarity_mean_prop.qs")))
  ...
  rast_impact_rarity_km2 <- all_impact_df %>%
        ...
        qsave(rast_impact_rarity_km2, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_by_material/{diet}/{fcr}/{allocation}_{raw_material}_rarity_mean_km2.qs")))
    ...
    rast_impact_total_km2 <- all_impact_df %>%
        ...
        qsave(rast_impact_total_km2, glue(file.path(biodiv_dir, "int/terrestrial_aggregation/impact_maps_across_taxon_by_material/{diet}/{fcr}/{allocation}_{raw_material}_total_km2.qs")))
...
foreach(allocation = allocation_types,
  ...
  rast_impact_rarity_prop <- all_impact_df %>%
        ...
        qsave(rast_impact_rarity_prop, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_across_taxon_by_material/{diet}/{fcr}/{allocation}_{raw_material}_rarity_mean_prop.qs")))
  ...
  rast_impact_rarity_km2 <- all_impact_df %>%
        ...
        qsave(rast_impact_rarity_km2, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_across_taxon_by_material/{diet}/{fcr}/{allocation}_{raw_material}_rarity_mean_km2.qs")))
    ...
    rast_impact_total_km2 <- all_impact_df %>%
        ...
        qsave(rast_impact_total_km2, glue(file.path(biodiv_dir, "int/marine_aggregation/impact_maps_across_taxon_by_material/{diet}/{fcr}/{allocation}_{raw_material}_total_km2.qs")))
