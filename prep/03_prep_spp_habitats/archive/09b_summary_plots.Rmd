...
plot1_legend <- get_legend(ggplot(summary_df, aes(x = mean_ext_risk)) +
  geom_boxplot(aes(y = taxon, fill = diet, color = diet), 
               width = 0.3, position = position_dodge(width = -0.7),
...
ggsave(here("prep/03_prep_spp_habitats/output/plots/publication/economic_boxplot.png"), width = 16, height = 9, units = "in")
