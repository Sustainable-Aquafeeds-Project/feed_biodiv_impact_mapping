...
# types_df <- grep(pattern = "nspp", types_df, value = TRUE)
...
for(allocation_type in allocations){
  ...
  # }
        ...
        delta_df <- fread(glue(file.path(impact_maps_dir, "csvs/impact_maps_across_taxon_by_ingredient/delta/{allocation_type}_{taxa_type}_{type}.rds.gz")))
