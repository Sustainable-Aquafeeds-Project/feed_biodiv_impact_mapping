...
ggsave(here("prep/03_prep_spp_habitats/output/plots/publication/iucn_plot.png"), units = "mm", width = 180, height = 180)
...
test3 <- plot_df  %>%
  ...
  ungroup() %>%
  filter(!(taxon_plot %in% c("Arthropods", "Other marine species", "Molluscs", "Finfish")))
