...
ggsave(here("prep/03_prep_spp_habitats/output/plots/publication/economic_boxplot_prop.png"), width = 16, height = 9, units = "in", bg = "white") # technically for nature food the max width is 180 mm, however, I'm saving like this and adjusting save in post production because doing it here messing things up...
...
ggsave(here("prep/03_prep_spp_habitats/output/plots/publication/economic_barchart.png"), width = 178.9, height =100.92 , units = "mm", bg = "white")
...
ggsave(here("prep/03_prep_spp_habitats/output/plots/publication/SI/barchart_by_raw_mat.png"), bg = "white")
