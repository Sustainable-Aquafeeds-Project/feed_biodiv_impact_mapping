...
# + 
#         geom_text(data = spp_assesed_reg_outlier, aes(label = spp_impacted_str, y = taxon),
#                 x = 0.000035, hjust = 0, color = 'black',
#                 family = 'arial',
#                 size = 6)
...
ggsave(here("prep/03_prep_spp_habitats/output/plots/publication/economic_barchart.png"))
