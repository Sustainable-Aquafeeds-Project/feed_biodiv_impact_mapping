...
sum(test_terr$impact_total, na.rm = TRUE) # 754891.7
mean(test_terr$impact_total, na.rm = TRUE) # 6.140526
...
sum(test_marine$impact_total, na.rm = TRUE) # 135137.3
mean(test_marine$impact_total, na.rm = TRUE) # 1.86824
