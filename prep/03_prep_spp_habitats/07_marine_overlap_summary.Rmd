...
length(unique(impact_df$SpeciesID)) # 20335 missing some spp.. however, we filtered out the species that aren't vulnerable, so this makes sense (see check that I did in the terrestrial overlap summary RMD)
...
sum(test_marine$impact_total, na.rm = TRUE) # 130228.9
mean(test_marine$impact_total, na.rm = TRUE) # 1.845072
