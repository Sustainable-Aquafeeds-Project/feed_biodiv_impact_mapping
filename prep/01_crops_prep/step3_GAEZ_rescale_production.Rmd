...
# Data information
Crop Allocation Source: GAEZ 2015 [Accessed: 07/12/2023]


We will be rescaling the Production_*_Total rasters to represent 2021 FAO tonnage estimates. These represent the 2015 total production (it is actually the average of 2014, 2015, and 2016) in tonnes per each crop in each cell. Units are 1000 tonnes per 5-arcminute grid cell.
