...
sum(test$area_fmfo, na.rm = TRUE) # 77861.26 ok that is more than rich... we are supposed to have more, but does that much more make sense? need to see what trimmings adds since he includes trimmings too... 
...
sum(global(compare_rich, "sum", na.rm = TRUE)) # 17446.36 km2 way less than me.. but that makes sense, sense his is only 100k tonnes.

# rich is based off of 100k tonnes and gets 17446 km2
# so 100000/17446 = 5.731973
# 1093060/77861.26 = 14.03856.. but his includes trimmings... 
...
global(test2, "sum", na.rm = TRUE) # 452805.9

sum(test$fmfo_embodied_fish) # 184281 tonnage
sum(test$area_fmfo, na.rm = TRUE) # 452806.2.. really big number
...
sum(test$fmfo_embodied_fish) # 1277342 tonnage
sum(test$area_fmfo, na.rm = TRUE) # 530667.4

1277342/530667.4 # 2.407048
