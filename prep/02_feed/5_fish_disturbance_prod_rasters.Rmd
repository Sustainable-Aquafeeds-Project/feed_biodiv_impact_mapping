...
test_reg <- rast(here("prep/02_feed/output/fish-dominant/regular/forage fish_fish meal_economic_benthic_catch_A.tif"))
  
test_eff <- rast(here("prep/02_feed/output/fish-dominant/efficient/forage fish_fish meal_economic_benthic_catch_A.tif"))


test_diff <- (test_reg - test_eff)/test_reg

plot(test_diff) # should all be ~0.1; 10% decrease in FCR
```  
