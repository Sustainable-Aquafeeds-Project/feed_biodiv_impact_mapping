...
global(test, "sum", na.rm = TRUE) # 2473.317 km2
```  
...
global(test2, "sum", na.rm = TRUE) # 2473.317 km2

sum(test$fmfo_embodied_fish) # 215954.7 tonnage
sum(test$area_fmfo, na.rm = TRUE) # 2473.317 km2
...
sum(test$fmfo_embodied_fish) # 1372057 tonnage
sum(test$area_fmfo, na.rm = TRUE) # 8892.487

1360597/8892.487 # 153.0052
