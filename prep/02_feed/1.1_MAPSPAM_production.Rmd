...
compare
sum(compare$our_tonnes, na.rm=TRUE)/sum(compare$total, na.rm = TRUE) # teas and rest categories are problematic... everything else looks ok though... I'm gonna be filtering out those anyway... (I think)
