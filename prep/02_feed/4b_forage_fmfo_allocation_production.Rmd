...
sum(forage_fofm_allocation$tonnes_fofm_spp_live_weight) # 16702864/2 = 8351432 seems excessive, ~3.8x more than the demand. Do fish weigh 4x more than meal and oil? 

8351432/2129803 # 3.921223

mean(forage_fofm_allocation$allocation_value) # 3.946963.. yeah, they do. 
...
forage_files <- list.files(here("prep/02_feed/output/fish-dominant"), pattern = "fish oil|fish meal", full.names = TRUE)[1:4]
...
#                                      sum
# forage fish_fish meal_ge_P.tif   2283356
# forage fish_fish meal_mass_P.tif 2683852
# forage fish_fish oil_ge_P.tif    3801382
# forage fish_fish oil_mass_P.tif  2505857
