...
# plot(log(trimmings_fish_system + 1))
    ...
    writeRaster(trimmings_fish_system_catch, sprintf(here("prep/02_feed/output/%s/trimmings fish_%s_%s_%s_catch_P.tif"), diet_type, ingredient_type, allocation, pos), overwrite = TRUE)
...
# plot(log(trimmings_fish_system + 1))
    ...
    writeRaster(trimmings_fish_system_bycatch, sprintf(here("prep/02_feed/output/%s/trimmings fish_%s_%s_%s_bycatch_P.tif"), diet_type, ingredient_type, allocation, pos), overwrite = TRUE)
...
trim_files <- list.files(here("prep/02_feed/output/fish-dominant"), pattern = "fish oil|fish meal|trimmings", full.names = TRUE)
