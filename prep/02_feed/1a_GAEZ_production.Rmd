...
Calculates total crop production using the GAEZ data adjusted to mean of 2019-2021 production. These data include all growing systems (intensive, irrigated, etc.) and are in units of metric tonnes.
