...
1. Map crop production coefficients from 2010 to 2021.
2. Produce maps scaled to 2021 for each crop category 
...
# Scaled maps
scaled_test <- raster(file.path(mapspam_dir, "/scaled_maps_2021/crop_cnut_A_scaled.tif"))
plot(scaled_test)
